...
namespace WebWooden.Areas.Admin.Controllers
{
    ...
    public class ProductsController : Controller
    {
        ...
        public ProductsController(WoodContext context)
        {
            _context = context;
        }
        ...
        {
            var woodContext = _context.TbProducts.Include(t => t.CategoryProduct);
            return View(await woodContext.ToListAsync());
        }
        ...
        public async Task<IActionResult> Create([Bind("ProductId,Title,Alias,CategoryProductId,Description,Detail,Image,Price,PriceSale,Quantity,CreatedDate,CreatedBy,ModifiedDate,ModifiedBy,IsNew,IsBestSeller,UnitInStock,IsActive,Star")] TbProduct tbProduct)
        {
            ...
            {
                tbProduct.Alias = WebWooden.Utilities.Function.TitleSulgGenerationAlias(tbProduct.Alias);
